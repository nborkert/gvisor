...
// endpoint. It assumes that the IP header is already present
// in pkt.NetworkHeader. pkt.TransportHeader may be set. The mtu is the one of
// the link endpoint. This does not support the DontFragment IP flag.
